...
function validate(input) {
    return __awaiter(this, void 0, void 0, function () {
        var id, progress, manifest, to, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    progress = ora_1.default('Installing ...').start();
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 2:
                    ...
                    return [2 /*return*/, { id: id, progress: progress, to: to, name: manifest.name, deps: manifest.dependencies }];
                case 3:
                    e_1 = _a.sent();
                    progress.fail(e_1.message);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, __2.npm('i --only=prod --no-warnings --no-progress --silent')];
                case 4:
                    output = _a.sent();
                    args.progress.succeed("Successfully installed");
                    return [2 /*return*/, { path: args.to, output: output }];
            }
        });
    });
}
